...
import { makeCastformRagProject } from "@/server/castform/rag-project"
...
async function generateBundle(
  ...
  const castformRagProject = makeCastformRagProject({
    projectId,
    title: plan.domainSpec.title,
    domain: plan.domainSpec.domain,
    targetUser: plan.domainSpec.targetUser,
    userIntent: plan.modelGoal.userIntent,
    modelGoal: plan.modelGoal,
    sources,
    documents,
    chunks,
    trainQa,
  ...
  return {
    ...
    castformFiles: castformRagProject.files,
  }
}
